...
const LEVEL_CONTENT: Record<number, LevelContent> = {
  ...
  6: {
    ...
    type: "tap-select",
    randomize: true,
    itemLabels: ["Wheat", "Gears", "Bolts", "Wind", "Banana", "Balloon"],
  },
  7: {
    era: "innovators",
    items: ["🧹💨", "🍞⚡🔥", "🧼💦🌀", "🚗⚡", "🚜🌱✂️", "💦🌼🌱"],
    ...
    type: "tap-select",
    randomize: true,
    itemLabels: ["Vacuum", "Toaster", "Washing Machine", "Electric Car", "Lawn Mower", "Sprinkler"],
  },
  8: {
    era: "pioneers",
    items: ["ㄱ", "ㄴ", "ㅁ", "ㅂ", "ㅅ"],
  ...
  9: {
    ...
    type: "tap-select",
    randomize: true,
    itemLabels: ["Plan", "Plane", "Ocean", "World", "Trophy"],
  },
  10: {
    era: "pioneers",
