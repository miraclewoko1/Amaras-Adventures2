...
const translations: Record<Language, Translations> = {
  en: {
    ...
    histL3Greeting: "Thinking is my favorite thing! I studied science and philosophy. Can you find the concepts that come from the mind?",
    histL3Activity: "Tap the concepts: Love, Knowledge, Art! (Not tools)",
  ...
  ko: {
    ...
    histL3Greeting: "생각하는 것이 내가 가장 좋아하는 일이에요! 나는 과학과 철학을 공부했어요. 마음에서 나오는 개념을 찾을 수 있나요?",
    histL3Activity: "개념을 탭하세요: 사랑, 지식, 예술! (도구가 아닌)",
